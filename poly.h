...
#ifndef POPRAWKA_DUZE_ZADANIE_POLY_H
#define POPRAWKA_DUZE_ZADANIE_POLY_H

/** @file
  Interfejs klasy wielomianów rzadkich wielu zmiennych

  @authors Jakub Pawlewicz <pan@mimuw.edu.pl>, Marcin Peczarski
  <marpe@mimuw.edu.pl>, Jakub Krakowiak <jk429351@students.mimuw.edu.pl>
...
/**
 * Sprawdza, czy wielomian jednomianu jest tożsamościowo równy zeru.
 * @param[in] m : jednomian
 * @return Czy wielomian jednomianu jest równy zeru?
 */
...
/**
 * Podstawia wielomiany q1, q2, q3, ... qk pod kolejne zmienne w wielomianie p.
 * @param[in] p : wielomian @f$p@f$
...
#endif //POPRAWKA_DUZE_ZADANIE_POLY_H